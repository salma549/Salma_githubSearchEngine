...
//     <>
//       {/* Hero Section */}
//       <div className="bg-gradient-to-r from-purple-500 to-blue-600 text-white py-10 text-center relative overflow-hidden">
//         <div className="absolute inset-0 opacity-50">
//           <svg
//             className="w-full h-full"
//             viewBox="0 0 1440 320"
...
//       <div className="container mx-auto mt-10 max-w-7xl px-4 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
//         {/* Profile Section */}
//         <div className="bg-white shadow-lg rounded-lg p-8 text-center transition-transform transform hover:scale-110 hover:shadow-xl hover:*:cursor-pointer">
...
//             src={avatar_url}
//             alt={name}
//             className="w-36 h-36 md:w-48 md:h-48 rounded-full mx-auto mb-6 border-4 border-blue-500 object-cover shadow-lg transform transition-all duration-300 hover:scale-110"
//           />
...
//         {/* Bio and Social Links Section */}
//         <div className="bg-white shadow-lg rounded-lg p-8 transition-transform transform hover:scale-110 hover:shadow-xl hover:cursor-pointer">
//           {bio && (
//             <>
//               <h2 className="text-xl md:text-2xl font-semibold mb-4 text-center">Bio</h2>
//               <p className="text-lg text-gray-600 leading-relaxed mb-6">{bio}</p>
//             </>
//           )}
...
//       {/* Stats Section */}
//       <div className="container mx-auto mt-10 px-4 lg:px-6 mb-10 hover:cursor-pointer">
//         <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
//           <div className="bg-gradient-to-r from-green-400 to-blue-500 text-white py-6 rounded-lg shadow-md text-center transition-transform transform hover:scale-110 hover:shadow-xl">
//             <h3 className="text-lg">Followers</h3>
//             <p className="text-2xl font-bold">{followers}</p>
...
function UserPage({ getUser, user }) {
  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-10 max-w-7xl px-4 lg:px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Profile Section */}
        <div className="bg-white shadow-lg rounded-lg p-8 text-center transition-transform transform hover:scale-110 hover:shadow-xl">
          <h2 className="text-xl md:text-2xl font-semibold mb-4">
            {hireable ? (
